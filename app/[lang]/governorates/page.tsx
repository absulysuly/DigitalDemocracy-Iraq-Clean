  ...
  if (!FEATURE_FLAGS.ELECTION_ENABLED) {
    return (
      <DisabledNotice
        ...
        description="Election governorate browsing is currently disabled. Set VITE_ENABLE_ELECTIONS=true or NEXT_PUBLIC_ENABLE_ELECTIONS=true to re-enable this page."
      />
    );
  }
